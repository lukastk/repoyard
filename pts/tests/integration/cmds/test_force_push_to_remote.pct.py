...
#
# Tests for the `force-push` command that pushes a local folder to a repo's remote DATA location.
#
# Tests:
...
# - Push for excluded repo (no local DATA)
...
# %% [markdown]
# ## Test 5: Push for excluded repo (no local DATA)
...
# %% [markdown]
# ## Test 6: Include repo and verify pushed content
