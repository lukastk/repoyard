...
#
# Tests for renaming repositories and syncing names between local and remote.
#
# Tests:
# - Renaming a repo locally only
# - Renaming a repo on remote only
# - Renaming a repo on both local and remote
...
# %% [markdown]
# ## Test renaming a repo locally only
...
# %% [markdown]
# ## Test renaming a repo on remote only
...
# %% [markdown]
# ## Test renaming a repo on both local and remote
