...
__all__ = [
    "TestAsyncThrottler",
    "TestCheckLastTimeModified",
    "TestCountFilesInDir",
    "TestGetHostname",
    "TestGetRepoIndexNameFromSubPath",
    "TestIsInEventLoop",
    "TestRunCmdAsync",
    "TestSoftInterruption",
    "TestSoftInterruptionHandling",
]
...
class TestGetRepoIndexNameFromSubPath:
    ...
    def test_path_at_repos_root(self, mock_config):
        ...
        result = get_repo_index_name_from_sub_path(mock_config, str(mock_config.user_repos_path))
...
class TestGetHostname:
    ...
    def test_darwin_fallback_to_platform_node(self, mock_node, mock_run, mock_system):
...
class TestRunCmdAsync:
    ...
    def test_command_failure(self):
        ...
        async def _test():
            returncode, stdout, stderr = await run_cmd_async(["python", "-c", "import sys; sys.exit(1)"])
            assert returncode == 1
    ...
    def test_command_with_arguments(self):
        ...
        async def _test():
            returncode, stdout, stderr = await run_cmd_async(["python", "-c", "print('arg1', 'arg2')"])
            assert returncode == 0
...
from repoyard._utils import check_interrupted
