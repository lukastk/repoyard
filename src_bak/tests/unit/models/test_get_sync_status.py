...
__all__ = [
    "TestGetSyncStatusBasicScenarios",
    "TestGetSyncStatusConflict",
    "TestGetSyncStatusErrors",
    "TestGetSyncStatusIncomplete",
    "TestGetSyncStatusNeedsPull",
    "TestGetSyncStatusNeedsPush",
    "TestGetSyncStatusReturnValue",
    "TestGetSyncStatusSynced",
    "TestGetSyncStatusTypeMismatch",
    "make_sync_record",
]
...
from repoyard._models import SyncCondition, SyncRecord, SyncStatus, get_sync_status
...
class TestGetSyncStatusNeedsPush:
    ...
    def test_needs_push_when_local_modified_after_sync(self, tmp_path):
        ...
        async def _test():
            ...
            mock_record.ulid = shared_ulid
            mock_record.sync_complete = True
            mock_record.timestamp = datetime.now(UTC) - timedelta(hours=2)
            ...
            with (
                ...
                patch(
                    "repoyard._utils.check_last_time_modified",
                    return_value=datetime.now(UTC),  # Modified after sync
                ),
                patch.object(
                    SyncRecord,
                    "rclone_read",
...
class TestGetSyncStatusNeedsPull:
    ...
    def test_needs_pull_when_remote_more_recent(self, tmp_path):
        ...
        async def _test():
            ...
            local_record.timestamp = datetime.now(UTC) - timedelta(hours=2)
            ...
            remote_record.timestamp = datetime.now(UTC)
...
class TestGetSyncStatusConflict:
    ...
    def test_conflict_when_both_modified(self, tmp_path):
        ...
        async def _test():
            ...
            with (
                ...
                patch(
                    "repoyard._utils.check_last_time_modified",
                    return_value=datetime.now(UTC),  # Local also modified
                ),
                patch.object(
                    SyncRecord,
                    "rclone_read",
    ...
    def test_conflict_when_local_more_recent(self, tmp_path):
        ...
        async def _test():
            ...
            remote_record.ulid = ULID()
            remote_record.sync_complete = True
            remote_record.timestamp = datetime.now(UTC) - timedelta(hours=2)
            ...
            local_record.ulid = ULID()
            local_record.sync_complete = True
            local_record.timestamp = datetime.now(UTC)
