...
__all__ = [
    "TestGetFilteredRepoMetas",
    "TestIsSubsequenceMatch",
    "TestNameMatchMode",
    "TestRepoPathInference",
...
from repoyard._cli.main import NameMatchMode, _get_filtered_repo_metas, _is_subsequence_match
...
class TestGetFilteredRepoMetas:
    ...
    def test_group_filter_complex_expression(self):
        ...
        result = _get_filtered_repo_metas(repos, None, None, "(backend OR frontend) AND prod AND NOT deprecated")
        assert len(result) == 2
