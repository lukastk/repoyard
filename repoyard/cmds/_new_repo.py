...
def new_repo(
    ...
    # %% auto 0
    __all__ = ['config', 'repoyard_meta', 'repo_meta', 'repo_path', 'repo_data_path', 'repo_conf_path']
    ...
    from .._models import get_repoyard_meta, RepoPart
    ...
    # %% ../../../pts/mod/cmds/01_new_repo.pct.py 20
