# AUTOGENERATED! DO NOT EDIT! File to edit: pts/tests/unit/models/test_parents.pct.py

__all__ = ['TestBoxMetaParents', 'TestBoxyardMetaParentChild']

# %% pts/tests/unit/models/test_parents.pct.py 2
import pytest
...
# %% pts/tests/unit/models/test_parents.pct.py 3
...
# %% pts/tests/unit/models/test_parents.pct.py 4
...
# %% pts/tests/unit/models/test_parents.pct.py 5
