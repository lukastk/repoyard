...
class BoxyardLockManager:
    ...
    @contextmanager
    def box_sync_lock(self, index_name: str, timeout: float = REPO_SYNC_LOCK_TIMEOUT) -> Iterator[None]:
        """
...
async def async_box_sync_lock(
    lock_manager: BoxyardLockManager, index_name: str, timeout: float = REPO_SYNC_LOCK_TIMEOUT
):
    """
