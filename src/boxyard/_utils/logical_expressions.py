...
def _parse_or_expression(tokens: list[str], pos: list[int], box_groups: set[str]) -> bool:
...
def _parse_and_expression(tokens: list[str], pos: list[int], box_groups: set[str]) -> bool:
...
def _parse_not_expression(tokens: list[str], pos: list[int], box_groups: set[str]) -> bool:
...
def _evaluate_group_expression(expression: str, box_groups: set[str] | list[str]) -> bool:
