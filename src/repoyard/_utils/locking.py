...
__all__ = ['GLOBAL_LOCK_TIMEOUT', 'LOCK_POLL_INTERVAL', 'LockAcquisitionError', 'REPO_SYNC_LOCK_TIMEOUT', 'RepoyardLockManager', 'acquire_lock_async', 'async_global_lock', 'async_repo_sync_lock', 'cleanup_stale_locks', 'auto_cleanup_stale_locks']
...
async def async_global_lock(
    ...
    Uses polling to avoid blocking the event loop and ensure clean cancellation.
    """
